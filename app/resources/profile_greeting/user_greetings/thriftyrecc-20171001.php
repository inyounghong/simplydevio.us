...
$new_message1 = str_replace('visitor', $visitor, 'Good morning / afternoon / night visitor!');
$new_message2 = str_replace('visitor', $visitor, 'I see you peeping through my Halloween palace.');
...
$color = imagecolorallocate($im, 255, 127, 41);

...
$visitorScraper = new VisitorScraper("fizzypopsodas", false);
$visitor = $visitorScraper->getVisitor();
$new_message1 = str_replace('visitor', $visitor, '*stares at visitor*');
$new_message2 = str_replace('visitor', $visitor, 'hewwo there~');

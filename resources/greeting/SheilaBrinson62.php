...
$visitor = exec("python ../image_with_name.py 'SheilaBrinson'");
...
imagettftext($im, 24, 0, 43, 51, $color, $font, $new_message1);
imagettftext($im, 24, 0, 43, 103, $color, $font, $new_message2);
imagepng($im);
imagedestroy($im);
?>
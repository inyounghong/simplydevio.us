...
$new_message1 = str_replace('visitor', $visitor, 'Does your mom know you\'re talking');
$new_message2 = str_replace('visitor', $visitor, 'to a sex offender right now, visitor?!');

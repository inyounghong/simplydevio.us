...
$new_message1 = str_replace("visitor",$visitor, 'Hi and welcme to my page, visitor!');
...
$color = imagecolorallocate($im, 174, 255, 54);
imagettftext($im, 25, 0, 56, 74, $color, $font, $new_message1);

...
$visitor = exec("python ../image_with_name.py 'UndeadArmy'");
...
$background = imagecolorallocate($im, 0, 214, 193);
imagefill($im,0,0,$background);
$color = imagecolorallocate($im, 255, 255, 255);
imagettftext($im, 26, 0, 8, 40, $color, $font, $new_message1);
imagettftext($im, 26, 0, 8, 40, $color, $font, $new_message2);
imagepng($im);
imagedestroy($im);
?>
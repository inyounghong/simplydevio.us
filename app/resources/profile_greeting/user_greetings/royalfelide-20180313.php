...
$new_message1 = str_replace('visitor', $visitor, 'Hello wanderer');
$new_message2 = str_replace('visitor', $visitor, 'Welcome in my world!');
...
$background = imagecolorallocate($im, 204, 22, 22);

...
$visitorScraper = new VisitorScraper("space-scarly", false);
$visitor = $visitorScraper->getVisitor();
$new_message1 = str_replace('visitor', $visitor, '♥ My dear visitor,');
$new_message2 = str_replace('visitor', $visitor, 'welcome to my space world! ♥');
...
$color = imagecolorallocate($im, 255, 110, 197);

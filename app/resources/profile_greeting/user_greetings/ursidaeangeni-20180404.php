...
$new_message2 = str_replace('visitor', $visitor, 'Welcome to the world of Urisidae Angeni!');
...
$background = imagecolorallocate($im, 255, 209, 230);
imagefill($im,0,0,0x7fff0000);
$color = imagecolorallocate($im, 255, 138, 232);

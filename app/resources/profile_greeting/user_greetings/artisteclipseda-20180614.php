...
$visitorScraper = new VisitorScraper("artisteclipseda", false);
$visitor = $visitorScraper->getVisitor();
$new_message1 = str_replace('visitor', $visitor, 'Hey there visitor!');
$new_message2 = str_replace('visitor', $visitor, 'I notice you!');
...
$background = imagecolorallocate($im, 110, 230, 95);

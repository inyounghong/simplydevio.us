...
$new_message2 = str_replace("visitor",$visitor, 'No need to thank me for llamas, watches or favorites!');
...
imagettftext($im, 15, 0, 50, 20, $color, $font, $new_message1);
imagettftext($im, 15, 0, 49, 50, $color, $font, $new_message2);

...
$visitorScraper = new VisitorScraper("mauuwde", false);
$visitor = $visitorScraper->getVisitor();
$new_message1 = str_replace('visitor', $visitor, 'Heyuu visitor!');
$new_message2 = str_replace('visitor', $visitor, 'Have a great time here! ;v;');
...
$background = imagecolorallocate($im, 255, 214, 138);

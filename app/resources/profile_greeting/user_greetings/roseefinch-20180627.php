...
$visitorScraper = new VisitorScraper("roseefinch", false);
$visitor = $visitorScraper->getVisitor();
$new_message1 = str_replace('visitor', $visitor, 'Hello, visitor!');
$new_message2 = str_replace('visitor', $visitor, 'Welcome to my little forest!');
...
$color = imagecolorallocate($im, 3, 0, 0);

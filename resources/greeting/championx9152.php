...
$visitor = exec("python ../image_with_name.py 'championx91'");
...
imagettftext($im, 15, 0, 20, 53, $color, $font, $new_message1);
imagettftext($im, 15, 0, 50, 53, $color, $font, $new_message2);

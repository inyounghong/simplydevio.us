...
$text_box2 = imagettfbbox(41, 0, '../uploaded_fonts/where_stars_shine_the_brightest.ttf', $new_message2);
...
$color = imagecolorallocate($im, 218, 151, 127);
imagettftext($im, 41, 0, $x1, $y1, $color, '../uploaded_fonts/where_stars_shine_the_brightest.ttf', $new_message1);
imagettftext($im, 41, 0, $x2, $y2, $color, '../uploaded_fonts/where_stars_shine_the_brightest.ttf', $new_message2);
imagepng($im);
imagedestroy($im);
?>

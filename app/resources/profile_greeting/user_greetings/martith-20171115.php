...
$new_message1 = str_replace('visitor', $visitor, 'May the magic and the wonder of the holiday season');
$new_message2 = str_replace('visitor', $visitor, 'stay with you throughout the coming year, visitor!');
...
$color = imagecolorallocate($im, 148, 31, 31);

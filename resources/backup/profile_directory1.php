        ...
        <div class="map"><a href="index.php">Resources</a> > Profile Creator</div>
            ...
            <form action="" id="profileDirectory" name="example" onchange="checkit()">
                ...
                <div id="page1" class="tab_page selected">
                    ...
                    <div class="inputs">
                        <input class="i85" id="buttonFontFamily" value="Verdana">
            ...
            <div class="tab_page" id="page3">
                ...
                <div id="button_long" class="w1">
                    <b>Long</b><br>
                    <input type="checkbox" class="check long" id="long0" checked><br>
                    <input type="checkbox" class="check long" id="long1"><br>
                    <input type="checkbox" class="check long" id="long2"><br>
                    <input type="checkbox" class="check long" id="long3"><br>
                    <input type="checkbox" class="check long" id="long4"><br>

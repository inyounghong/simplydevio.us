...
$new_message1 = str_replace('visitor', $visitor, 'Long time no see you my friend');
$new_message2 = str_replace('visitor', $visitor, 'Feel free to explore my word !');
...
$color = imagecolorallocate($im, 12, 13, 56);

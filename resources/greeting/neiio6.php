...
$visitor = exec("python ../image.py 'neiio'");
...
$im = imagecreatetruecolor ($width,47);
$background = imagecolorallocate($im, 129, 67, 81);
imagefill($im,0,0,$background);
$color = imagecolorallocate($im, 255, 255, 255);
imagettftext($im, 23, 0, 0, 28, $color, $font, $new_message1);

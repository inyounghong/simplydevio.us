...
$new_message2 = str_replace("visitor",$visitor, 'No need to thank me for favorites, watches and llamas!');
...
imagettftext($im, 15, 0, 141, 20, $color, $font, $new_message1);
imagettftext($im, 15, 0, 68, 44, $color, $font, $new_message2);

...
$visitor = exec("python ../image_with_name.py 'EinnhardeR'");
...
$im = imagecreatetruecolor ($width,121);
$background = imagecolorallocate($im, 255, 255, 255);
imagefill($im,0,0,$background);
$color = imagecolorallocate($im, 0, 0, 0);
imagettftext($im, 26, 0, 61, 54, $color, $font, $new_message1);
imagettftext($im, 26, 0, 94, 88, $color, $font, $new_message2);
imagepng($im);
imagedestroy($im);
?>
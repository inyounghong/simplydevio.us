...
$visitor = exec("python ../image_with_name.py 'dAhub'");
$new_message1 = str_replace("visitor",$visitor, 'Welcome, visistor!');
...
$background = imagecolorallocate($im, 251, 242, 255);
imagefill($im,0,0,$background);
$color = imagecolorallocate($im, 26, 255, 18);
